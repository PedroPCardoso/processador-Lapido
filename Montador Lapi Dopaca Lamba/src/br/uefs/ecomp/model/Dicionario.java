...
public String operar(String s){
		...
		switch(s){
			...
			case "j": 		return "101xx00xxxxxxxxx";
			...
			case "jt.zero": return "110100000000XXXX";
			case "jt.overflow":	return "110100000001XXXX";
			case "jt.neg": return "110100000010XXXX";
			case "jt.negzero":return "110100000011XXXX";
			case "jt.carry":return "110100000100XXXX";
								
			case "jf.zero": return "110100010101XXXX";
			case "jf.overflow":	return "110100010110XXXX";
			case "jf.neg": return "110100010111XXXX";
			case "jf.negzero":return "110100011000XXXX";
			case "jf.carry":return "110100011001XXXX";
